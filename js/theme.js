    ...
    $jscomp.polyfill = function(b, h, d, p) {
        if (h) {
            ...
            p = d[b];
            h = h(p);
            h != p && null != h && $jscomp.defineProperty(d, b, {
                configurable: !0,
                writable: !0,
                value: h
            })
    ...
    (function() {
        ...
        function z(a, c, b) {
            ...
            l.contains("row") && (l.remove("row"),
            l.add("media-container-row"));
        ...
        Element.prototype.parents = function(a) {
            for (var c = [], b = this, d = void 0 !== a; null !== (b = b.parentElement); )
        ...
        Element.prototype.footerReveal = function() {
            function a() {
                !d && c.offsetHeight <= window.outerHeight ? (c.style.zIndex = "-999",
        ...
        k(function() {
                    ...
                    if (b) {
                        ...
                        if (c && (/youtu\.?be/g.test(c[3]) || /vimeo/g.test(c[3])))
                            if (c && /youtu\.?be/g.test(c[3])) {
                                ...
                                b += "//web.archive.org/web/20250226162746/https://img.youtube.com/vi/" + c[6] + "/maxresdefault.jpg";
                                var l = new Image;
                                l.onload = function() {
                                    if (120 === (l.naturalWidth || l.width)) {
                                        ...
                                        case "sddefault.jpg":
                                            ...
                                            break;
                                        default:
                                            m && (e.style.backgroundImage = 'url("images/no-video.jpg")',
                            ...
                            b = "";
                            a.querySelector(".mbr-fallback-image") && (b = window.getComputedStyle(a.querySelector(".mbr-fallback-image")).backgroundImage,
            ...
            window.addEventListener("scroll", function() {
                ...
                if (r) {
                    ...
                    b ? c != r.fixed && (k ? (r.fixed = c,
                    r.elm.classList.toggle("is-fixed")) : l = setTimeout(function() {
                        r.fixed = c;
                        r.elm.classList.toggle("is-fixed")
                    }, 40)) : (r.fixed = !1,
                    r.elm.classList.remove("is-fixed"))
                }
            });
            if (u)
            ...
            window.smartresize(function() {
                document.querySelectorAll(".mbr-embedded-video").forEach(function(a) {
                    a.style.height = (p(a) * parseInt(a.getAttribute("height") || 315) / parseInt(a.getAttribute("width") || 560)).toFixed() + "px"
                })
            });
            if (u)
                g(document).on("add.cards", function(a) {
                ...
                if (!x() && document.querySelectorAll("input[name=animation]").length) {
                    var a = function() {
                        ...
                        f.forEach(function(e) {
                            var l = e.offsetHeight
                              , f = d(e);
                            (f + l >= a && f - 50 <= c || b(e)) && e.classList.contains("hidden") && (e.classList.remove("hidden"),
                    ...
                    f = f.filter(function(a) {
                        if (!a.parents().filter(function(a) {
                            if (a.matches("a, p, .navbar, .mbr-arrow, footer, .iconbox, .mbr-slider, .mbr-gallery, .mbr-testimonial .card-block, #cookiesdirective, .mbr-wowslider, .accordion, .tab-content, .engine, #scrollToTop, .modal"))
                                return !0
                        }).length)
                            return !0
                    });
        ...
        document.querySelectorAll("nav.navbar").length && (w = d(document.querySelector("nav.navbar")),
        document.querySelector(".mbr-after-navbar.mbr-fullscreen") && (document.querySelector(".mbr-after-navbar.mbr-fullscreen").style.paddingTop = w + "px"));
                ...
                document.querySelectorAll(".modalWindow-video > iframe").forEach(function(a) {
                    ...
                    if (b) {
                        ...
                        if (-1 !== b.indexOf("youtu"))
                            a.setAttribute("src", "https://web.archive.org/web/20250226162746/https://youtube.com/embed/" + c[6] + "?rel=0&enablejsapi=1");
                        else if (-1 !== b.indexOf("vimeo"))
                            a.setAttribute("src", "https://web.archive.org/web/20250226162746/https://player.vimeo.com/video/" + c[6] + "?autoplay=0&loop=0");
        ...
        if (!m) {
            ...
            !x() && (w = document.querySelector("section.menu")) && (A = window.innerWidth,
            !w.querySelector(".navbar").classList.contains("collapsed") && 991 < A && (w.querySelectorAll("ul.navbar-nav li.dropdown").forEach(function(a) {
        ...
        m || ("undefined" === typeof window.initClientPlugin && 0 != document.body.querySelectorAll(".clients").length && (window.initClientPlugin = !0,
        ...
        document.querySelectorAll('.accordionStyles > .card > .card-header > a[role="button"]').forEach(function(a) {
            a.addEventListener("click", function() {
                ...
                f.classList.add("mbri-arrow-down")) : (f.classList.remove("mbri-arrow-down"),
        ...
        if (m) {
            if (!u)
                return;
            g(document).on("add.cards", function(a) {
                g(a.target).find(".form-with-styler").length && (a = g(a.target).find(".form-with-styler"),
                g(a).find('select:not("[multiple]")').each(function() {
