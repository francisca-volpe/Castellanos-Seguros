      ...
      , checkIE = function() {
        ...
        if ("Microsoft Internet Explorer" == navigator.appName) {
            ...
            if (9 == a && "BackCompat" == document.compatMode)
                return a = document.createElement("meta"),
      ...
      , disclosure = function(a) {
        ...
        if (a.cookieScripts) {
            ...
            if (1 < b) {
                ...
                d = " We use a " + c[0] + " script which sets cookies."
        }
        if (a.customDialogSelector) {
            ...
            if (a.explicitConsent) {
                ...
                if (!f)
                    return;
                e.appendChild(f);
                "2" === a.cookiesAlertType && (e = document.createElement("a"),
                e.id = "explicitreject",
                e.innerText = a.rejectText || "Reject",
                e.classList.add("btn"),
                e.classList.add("btn-white"),
                e.classList.add("display-7"),
                e.setAttribute("style", "margin:0 5px;" + (a.rejectColor ? " background-color:" + a.rejectColor + " !important;color:" + invertHex(a.rejectColor) + "!important;" : "") + "border-color:" + a.rejectColor + " !important;border:0px solid; padding:5px 20px; border-radius:2px; cursor: pointer;box-shadow: 0 2px 2px 0 rgb(0 0 0 / 20%);"),
                f.appendChild(e));
                b.querySelector("a#explicitsubmit") || (b = document.createElement("a"),
                b.id = "explicitsubmit",
                b.innerText = a.textButton || "Continue",
                b.classList.add("btn"),
                b.classList.add("btn-primary"),
                b.classList.add("display-7"),
                b.setAttribute("style", "margin:0 5px;" + (a.colorButton ? " background-color:" + a.colorButton + " !important;color:" + invertHex(a.colorButton) + "!important;" : "") + "border-color:" + a.colorButton + " !important;border:0px solid; padding:5px 20px; border-radius:2px; cursor: pointer;box-shadow: 0 2px 2px 0 rgb(0 0 0 / 20%);"),
                f.appendChild(b),
                ...
                b.querySelector("a#impliedsubmit") || (f = document.createElement("a"),
                f.id = "impliedsubmit",
            ...
            if (f = c.querySelector("#epdnotick"))
            ...
            c.setAttribute("style", "font-family:sans-serif;position:" + a.css + ";" + a.position + ":-300px;left:0px;width:100%;height:auto;background:" + a.backgroundColor + ";color:" + a.fontColor + ";text-align:center;z-index:1050;");
            ...
            a.message || (a.explicitConsent ? (a.message = "This site uses cookies. Some of the cookies we ",
            a.message += "use are essential for parts of the site to operate and have already been set.") : a.message = "We have placed cookies on your computer to help make this website better.");
            ...
            if (a.explicitConsent) {
                ...
                d.setAttribute("style", "margin:0;" + (a.colorButton ? " background-color:" + a.colorButton + " !important;color:" + invertHex(a.colorButton) + "!important;" : "") + (a.colorButton && self === top ? "border-color:" + a.colorButton + " !important;" : "")),
                d.id = "impliedsubmit",
