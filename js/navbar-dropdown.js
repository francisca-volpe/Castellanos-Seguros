...
}
{
    ...
    $jscomp.polyfill("Array.from", function(b) {
        return b ? b : function(b, a, d) {
            ...
            ;
            var e = []
              , c = "undefined" != typeof Symbol && Symbol.iterator && b[Symbol.iterator];
            if ("function" == typeof c) {
                ...
                for (c = b.length,
                f = 0; f < c; f++)
                    e.push(a.call(d, b[f], f));
            return e
        }
    }, "es6", "es3");
    (function() {
        function b(a) {
            "resize" === a.type && (document.body.classList.remove("navbar-dropdown-open"),
            ...
            Array.from(document.querySelector(".navbar-dropdown").querySelectorAll('.navbar-toggler[aria-expanded="true"]')).forEach(function(b) {
                var a = b.querySelector(b.getAttribute("data-target"));
                a && (a.classList.remove("in"),
            ...
            Array.from(document.querySelectorAll(".navbar-dropdown")).forEach(function(a) {
                a.matches(".navbar-fixed-top") && (a.matches(".transparent") && !a.classList.contains("opened") && (0 < b ? a.classList.remove("bg-color") : a.classList.add("bg-color")),
                0 < b ? a.classList.add("navbar-short") : a.classList.remove("navbar-short"))
            })
        }
        var c;
        ...
        ["show.bs.collapse", "hide.bs.collapse"].forEach(function(a) {
            document.addEventListener(a, function(b) {
                if (b = b.target.closest(".navbar-dropdown"))
                    "show.bs.collapse" === a ? (document.body.classList.add("navbar-dropdown-open"),
                    b.classList.add("opened")) : (document.body.classList.remove("navbar-dropdown-open"),
...
playback timings (ms):
  ...
  load_resource: 117.137 (2)
  PetaboxLoader3.resolve: 95.657 (2)
  PetaboxLoader3.datanode: 99.723 (5)
  captures_list: 0.714
  exclusion.robots: 0.057
  exclusion.robots.policy: 0.044
  esindex: 0.013
  cdx.remote: 19.327
  LoadShardBlock: 109.555 (3)
*/
